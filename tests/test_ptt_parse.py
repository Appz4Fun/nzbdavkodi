...
@pytest.mark.parametrize(
    ...
    [
        ...
        # It leaves one character if there is space e.g. '★ The Dark Knight ★' -> 'The Dark Knight ★'
        # Looking at STAR_REGEX_1 = re.compile(r"^[\[【★].*[\]】★][ .]?(.+)")
        # It expects the title after the star block. e.g. "★ Some tag ★ The Title" -> "The Title"
        ...
        ("The.Matrix 1999", "The.Matrix 1999"), # Contains space, shouldn't replace dots
